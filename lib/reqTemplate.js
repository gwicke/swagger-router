...
var globalMethods = {
    ...
    if: function(pred, trueVal, falseVal) {
    ...
    uriTemplate: function(tpl, globalsInit) {
        var globals = Object.assign({}, globalMethods, globalsInit);
        var compiledTpl = new Template({ uri: tpl }, globals);
        return function(model) {
            return compiledTpl.expand(model).uri;
        };
    },

    requestTemplate: function(spec, globals) {
        var tpl = new Template(spec, globals);
        return function(model) {
